...
from PairsContainer import SameTeamPairsContainer
...
class TestSameTeamPairsContainer(TestCase):
    def setUp(self):
        self.stpc = SameTeamPairsContainer()
    
    def test_get_wins_loses(self):
        same_team_pairs = {(1, 4): [1, 2]}
        stpc = SameTeamPairsContainer(same_team_pairs)
    ...
    def test_increment_win_ordered_keys(self):
        ...
        self.assertEqual(stpc.team_pairs[3, 5], [2, 0])
        self.assertEqual(stpc.team_pairs[4, 5], [1, 0])
    ...
    def test_increment_win_reverse_keys(self):
        ...
        self.assertEqual(stpc.team_pairs[6, 9], [2, 0])
        self.assertEqual(stpc.team_pairs[8, 9], [1, 0])
    ...
    def test_increment_win_mixture_keys(self):
        ...
        self.assertEqual(stpc.team_pairs[10, 12], [3, 0])
    ...
    def test_increment_lose_ordered_keys(self):
        ...
        self.assertEqual(stpc.team_pairs[3, 5], [0, 2])
        self.assertEqual(stpc.team_pairs[4, 5], [0, 1])
    ...
    def test_increment_lose_mixture(self):
        ...
        self.assertEqual(stpc.team_pairs[6, 7], [0, 3])
    ...
    def test_increment_mixture(self):
        ...
        self.assertEqual(stpc.team_pairs[5, 7], [2, 1])
